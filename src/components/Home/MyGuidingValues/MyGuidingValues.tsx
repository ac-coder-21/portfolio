    ...
    return (
      <div className="flex flex-col justify-center items-center min-h-screen  dark:bg-gray-900">
        ...
        <div className="py-20 flex flex-col lg:flex-row items-center justify-center bg-white dark:bg-black w-full gap-4 mx-auto px-8">
          ...
          <Card title="Integrity is the foundation of my work" displayString="Integrity">
            <CanvasRevealEffect
              animationSpeed={3}
          ...
          <Card title="Driven by curiosity and lifelong learning" displayString="Continuous Learning">
            <CanvasRevealEffect
              animationSpeed={3}
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border  group/canvas-card flex items-center justify-center border-black/[0.2]  max-w-sm w-full mx-auto p-4 relative h-[30rem] bg-bgcolor"
    >
      ...
      <div className="relative z-20">
        <div className="font-bold text-center text-2xl text-gray-50 group-hover/canvas-card:-translate-y-4 group-hover/canvas-card:opacity-0 transition duration-200 w-full  mx-auto flex items-center justify-center">
          {displayString}
        </div>
